...
public class FaceRelativeLayout extends RelativeLayout implements
	...
	public interface OnhideSoftKeyboardListener {
		...
		void onSpannableString(SpannableString spannableString);
	}
	private OnhideSoftKeyboardListener hideListener;
	public void setOnhideSoftKeyboardListener(OnhideSoftKeyboardListener listener){
	...
	public void onClick(View v) {
		...
		case R.id.btn_face:
			...
			if(hideListener!=null)
				hideListener.onHideSoftKeyboard();
	...
	private void init_View() {
		...
		et_sendmessage = (EditText) findViewById(R.id.ed_dis_detail);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
		...
		if (!TextUtils.isEmpty(emoji.getCharacter())) {
			...
			if(hideListener!=null)
				hideListener.onSpannableString(spannableString);
		}
	}
}
