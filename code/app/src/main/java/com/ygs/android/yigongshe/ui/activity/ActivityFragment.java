...
public class ActivityFragment extends BaseFragment
    ...
    private void addHeadView() {
        int height = DensityUtil.dp2px(this.getActivity(),180);
        ...
        mBannerLayout.addView(activityStatusTypeView.getView(),layoutParams);
    }
    ...
    @Override
    public void OnStatusSelected(String item) {
        cate = item;
        refresh();
    }

    @Override
    public void OnTypeSelected(String item) {
        progress = item;
        refresh();
    }
