package com.ygs.android.yigongshe.ui.actionsheet;
...
public class ActionSheet extends Dialog implements OnClickListener
{
    ...
    {
        super(context, android.R.style.Theme_Holo_Light_NoActionBar);// 全屏
        ...
        if (items != null && items.size() > 0) {
            ...
            for (int i = 0; i < items.size(); i++) {
                ...
                if (i % 2 == 0){
                    ...
                    gray = Color.parseColor("#7cc576");
                }
                bt.setTextColor(gray);
    ...
    private class Attributes
    {
        ...
        public Attributes(Context context)
        {
            ...
            ColorDrawable gray = new ColorDrawable(color);
            ...
            this.otherButtonSpacing = 1; // dp2px(1);
            this.cancelButtonMarginTop = 1;//dp2px(10);
