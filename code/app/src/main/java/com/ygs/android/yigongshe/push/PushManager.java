...
public class PushManager {
   ...
   * 解析push调起协议
   */
  public void executePushJump(Context context, String url, boolean showNotif, String title,
      String content, PushObject pushObject) {
  ...
  private void openActivity(Class<? extends Activity> activityClass, Bundle bundle,
      boolean forResultCode, int resultCode) {
