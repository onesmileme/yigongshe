...
/**
 * Created by ruichao on 2018/7/26. 我的社团
 */
            ...
            public void onResponse(BaseResultDataInfo<MeCorporationBean> entity, Response<?> response,
                ...
                if (entity != null && entity.error == 2000) {
                    ...
                    mCall2.enqueue(new LinkCallbackAdapter<BaseResultDataInfo<ActivityListResponse>>() {
                        @Override
                        public void onResponse(BaseResultDataInfo<ActivityListResponse> entity,
                            ...
                            if (entity != null && entity.error == 2000) {
                                if (entity.data != null) {
                                    ...
                                    mNoCorporationTextView.setVisibility(View.VISIBLE);
                                }
                            }
                        }
                    });
