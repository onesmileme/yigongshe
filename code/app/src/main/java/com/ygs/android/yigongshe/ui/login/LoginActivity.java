...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initIntent(Bundle bundle) {
        ...
        canBack = bundle.getBoolean("canBack", false);
    ...
    protected void initView() {
        ...
        ImageButton backButton = titleBar.getLeftImageButton();
        if (canBack){
    ...
    private void loginAction() {
        ...
        mLoginCall.enqueue(new LinkCallbackAdapter<BaseResultDataInfo<LoginBean>>() {
            ...
            @Override
            public void onResponse(BaseResultDataInfo<LoginBean> entity, Response<?> response,
                                   Throwable throwable) {
